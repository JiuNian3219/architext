...
> **Scope:** `[?Data]` 僅適用於有資料層的專案。CLI/純計算專案可忽略。
> **Status:** [Sync Required]
> **Role:** 資料契約與結構鏡像 (Design Contract & Schema Snapshot)。
> **Source File:** *(AI: 依據 tech_stack 填寫，如 prisma/schema.prisma、models/*.py、schema.sql 等)*
