...
<step_3_constitution>
    ...
    **Rules**:
    ...
    - [?UI] `ui_concept.html`: **Not generated by this command.** After inherit completes, prompt the user to run the `archi-ui-wireframe` Skill to generate a global UI wireframe (based on the Roadmap feature modules already identified).
