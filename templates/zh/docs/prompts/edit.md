...
<step_1_load>
    **Role**: 产品经理
    **Action**:
    - 读取 `[[__DOCS_DIR__]]/features/<id>_<name>/1.spec.md`。
    - 读取 `[[__DOCS_DIR__]]/features/<id>_<name>/2.ui.md`。
    - 读取 `[[__DOCS_DIR__]]/features/<id>_<name>/3.plan.md`。
...
<step_4_summary>
    ...
    * `[[__DOCS_DIR__]]/features/<ID>_<Name>/2.ui.md` (已更新，如适用)
    * `[[__DOCS_DIR__]]/features/<ID>_<Name>/3.plan.md` (已追加新任务)
